...
# JMS_URL can be either the JumpServer API root, for example:
#   https://jumpserver.example.com/api/v1
# or the server root:
#   https://jumpserver.example.com
JMS_URL = env.str('JMS_URL', default='')
JMS_TOKEN = env.str('JMS_TOKEN', default='')
JMS_TIMEOUT = env.int('JMS_TIMEOUT', default=10)
JMS_ACCOUNT_NAME = env.str('JMS_ACCOUNT_NAME', default='default')
JMS_ACCOUNT_USERNAME = env.str('JMS_ACCOUNT_USERNAME', default='root')
JMS_DEFAULT_ACCOUNT_SECRET = env.str('JMS_DEFAULT_ACCOUNT_SECRET', default='')
JMS_DEFAULT_NODE_ID = env.str('JMS_DEFAULT_NODE_ID', default='')
JMS_FIELD_MAP = json.loads(env.str('JMS_FIELD_MAP', default='{}') or '{}')
JMS_NODE_MAP = json.loads(env.str('JMS_NODE_MAP', default='{}') or '{}')
JMS_PLATFORM_MAP = json.loads(env.str('JMS_PLATFORM_MAP', default='{"Linux": 1, "Windows": 5}') or '{}')
JMS_PROTOCOL_MAP = json.loads(env.str('JMS_PROTOCOL_MAP', default='{}') or '{}')
