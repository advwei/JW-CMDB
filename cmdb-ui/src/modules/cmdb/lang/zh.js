const cmdb_zh = {
    ...
    ciType: {
        ...
        adInterval: '采集频率',
        attributeMapHint: '配置自动发现的数据字段与模型属性的映射关系',
        byInterval: '按间隔',
        allNodes: '所有机器',
        allNodesTip: '安装了OneAgent的所有机器',
        specifyNodes: '指定机器',
        masterNode: 'Master机器',
        masterNodeTip: '安装OneMaster的所在机器',
        queryExprTip: '通过CMDB查询表达式动态选择执行机器',
        specifyNodesTips: '请填写指定机器！',
        username: '用户名',
        password: '密码',
        link: '链接',
        list: '多值',
        listTips: '允许该属性有多个值，如标签、IP地址等',
        ...
        aliasPlaceholder: '显示名称，如：主机名称',
        fieldCannotModify: '创建后不可修改',
        uniqueHint: '同一模型下该属性值不允许重复',
        sortableHint: 'CI列表支持按此字段排序',
        regCheckHint: '限制输入格式，如手机号、邮箱等',
        fontHint: '设置该字段在CI列表中的显示颜色和样式',
        choiceValueHint: '为该字段提供下拉选项，限制用户输入范围',
        isSortable: '可排序',
        isIndex: '是否索引',
        index: '索引',
        ...
        triggerDataChangeDesc: '当CI实例新增、删除或属性变更时触发',
        triggerDate: '日期属性',
        triggerDateDesc: '在指定日期属性到期前定时触发（如合同到期提醒）',
        triggerEnable: '开启',
        descInput: '请输入描述',
        ...
        deleteInstance: '删除实例',
        changeInstance: '实例变更',
        changeInstanceDesc: '选择后可指定监听哪些字段的变更',
        ...
        notifyAt: '发送时间',
        notify: '通知',
        filterDesc: '只对符合条件的CI实例触发，不填则对所有实例生效',
        dateTriggerdesc: '将在日期属性值前N天的指定时间触发通知',
        triggerAction: '触发动作',
        receivers: '收件人',
        ...
        inheritTypeHint: '可选择多个父模型进行多重继承',
        iconHint: '为模型选择一个识别图标，便于快速识别',
        ...
        isDynamic: '动态属性',
        dynamicTips: '频繁变化的数据（如CPU使用率）建议开启，不记录变更历史，提升性能',
        ...
        resourceSearchTip2: '注1：请使用表达式右侧的绿色按钮',
        resourceSearchTip2Suffix: '进行复制',
        resourceSearchTip3: '注2：如不需要筛选，请直接点击灰色按钮',
        resourceSearchTip3Suffix: '进行复制粘贴，即可配置为所有节点',
        enable: '开启',
        enableTip: '确定切换开启状态吗',
    ...
    说明:
    - 通过引用当前CI的其他属性值来计算生成新的属性值
    - 使用 {{属性名}} 访问属性值，例如: {{cpu}}, {{memory}}
    - 函数必须返回计算结果
    ...
    return`,
        ...
        onetermSync: {
            basicConfig: '基础配置',
            enableSync: '启用同步',
            enableSyncHint: '开启后，CI数据将自动同步到OneTerm堡垒机里的资产',
            syncStrategy: '同步策略',
            physicalMapping: '物理映射',
            physicalMappingTip: 'CI映射为物理资产（如服务器、网络设备），使用SSH/RDP等协议连接',
            logicalMapping: '逻辑映射',
            logicalMappingTip: 'CI映射为逻辑资产（如数据库实例），需要配置IP+端口',
            protocols: '支持协议',
            selectProtocols: '选择支持的访问协议',
            protocolsHint: '当属性映射中未配置协议字段时，使用此列表作为默认协议。可选择多个协议，如SSH+RDP',
            autoSync: '自动同步',
            autoSyncHint: 'CI数据变更时自动同步到OneTerm',
            attributeMapping: '属性映射',
            cmdbAttribute: 'CMDB属性',
            onetermField: 'OneTerm字段',
            status: '状态',
            configured: '已配置',
            notConfigured: '未配置',
            warning: '警告',
            ...
            addMapping: '添加映射',
            configErrors: '配置错误',
            requiredFieldNotMapped: '必填字段【{field}】未映射',
            duplicateMapping: '属性【{attr}】重复映射',
            attributeNotFound: '属性不存在',
            typeNotMatch: '类型不匹配',
            pleaseSelectAttribute: '请选择属性',
            loadAttributesFailed: '加载属性失败',
            loadLogsFailed: '加载日志失败',
            advancedConfig: '高级配置',
            assetNameTemplate: '资产命名模板',
            assetNameTemplatePlaceholder: '例如: {{ hostname }}-{{ ip }}',
            assetNameTemplateRequired: '请配置资产命名模板',
            assetNameTemplateDesc: '此模板用于生成OneTerm资产的名称（name字段），支持使用当前模型的属性',
            templateExplainDesc: '使用当前模型的属性组合生成OneTerm资产名称，支持Jinja2语法。点击下方属性标签即可插入变量。',
            templateVariableTip: '点击属性标签插入到模板',
            loadingAttributes: '加载属性中...',
            noAvailableAttributes: '暂无可用属性',
            previewResult: '预览',
            assetDirectoryRule: '资产目录规则',
            fixedDirectory: '固定目录',
            fixedDirectoryDesc: '所有资产放在同一个固定目录下',
            selectDirectory: '请选择目录',
            refreshDirectory: '刷新目录',
            rootDirectory: '根目录',
            loadDirectoryFailed: '加载目录失败',
            byCIAttribute: '按CI属性',
            ciAttributeDesc: '根据CI的某个属性值动态创建目录',
            attribute: '属性',
            pathTemplate: '路径模板',
            pathTemplatePlaceholder: '例如: {{ 环境 }}/{{ 区域 }}',
            pathTemplateExample: '如',
            attributeTemplateExample: '{{ 环境 }}/{{ 区域 }}',
            byCIRelation: '按CI关系',
            ciRelationDesc: '根据CI的关联关系动态创建目录',
            parentType: '关联模型',
            selectParentType: '请选择关联模型',
            relationTemplatePlaceholder: '例如: {{ 机房.名称 }}/{{ 机房.区域 }}',
            relationTemplateExample: '{{ 机房.名称 }}/{{ 机房.区域 }}',
            autoCreateAccount: '自动创建默认账号',
            autoCreateAccountHint: '同步时自动创建默认账号（需在OneTerm配置账号模板）',
            syncStatus: '同步状态',
            synced: '已同步',
            notSynced: '未同步',
            totalCIs: 'CI总数',
            ...
            syncAllNow: '立即全量同步',
            testSync: '测试同步',
            confirmSyncAll: '确认全量同步',
            confirmSyncAllContent: '将同步所有CI到OneTerm，是否继续？',
            syncTaskCreated: '同步任务已创建',
            syncCompleted: '同步完成',
            syncCompletedWithErrors: '同步完成但有错误',
            syncFailed: '同步失败',
            succeeded: '成功',
            failed: '失败',
            ...
            folderPath: '文件夹路径',
            testFailed: '测试失败',
            missingRequiredMapping: '请完成必填字段的映射配置',
            canceledChanges: '已取消修改',
            onetermFieldIp: 'IP地址',
            onetermFieldComment: '备注说明',
            onetermFieldProtocols: '协议列表',
            protocolsFormatHint: '协议格式支持：协议名称（使用默认端口）或 协议:端口（自定义端口）。多个协议用逗号分隔。',
            syncLog: '同步日志',
            searchCIName: '搜索CI名称',
            ...
            syncSuccess: '同步成功',
            noChanges: '无变更',
            unableUseTip: '社区版暂无法使用 OneTerm 同步功能, 需申请企业版且当前系统同时接入 CMDB 和 OneTerm 堡垒机模块'
        }
    },
    components: {
        ...
        readAttribute: '查看字段',
        readAttributeDesc: '可查看哪些字段',
        readCI: '查看实例',
        readCIDesc: '可查看哪些CI实例',
        config: '配置',
        configDesc: '允许修改模型定义、属性、关系等配置',
        grantDesc: '允许授予其他用户权限',
        ciTypeGrant: '模型权限',
        ciTypeGrantDesc: '配置哪些用户/角色可以查看和修改此模型的属性、关系等配置',
        ciGrant: '实例权限',
        ciGrantDesc: '配置哪些用户/角色可以查看、新增、修改、删除此模型下的CI实例',
        attributeGrant: '字段权限',
        relationGrant: '关系权限',
        relationGrantDesc: '配置哪些用户/角色可以管理此模型的关系定义',
        perm: '权限',
        all: '全部',
        allDesc: '可查看所有字段/实例',
        customize: '自定义',
        customizeDesc: '可查看指定的字段/符合条件的实例',
        none: '无',
        noneDesc: '不允许查看任何字段/实例',
        customizeFilterName: '请输入自定义筛选条件名',
        readAttrModalDesc: '配置该用户/角色可以查看哪些字段',
        readCIModalDesc: '配置该用户/角色可以查看哪些CI实例（支持动态筛选条件）',
    ...
    batch: {
        ...
        pleaseUploadFile: '还未上传文件',
        uploadFileHint: '在上一步中上传 Excel 文件后，数据将在此预览',
    ...
    preference: {
        ...
        autoSub2: '点击开启自动订阅',
        autoSubScope: '自动订阅范围',
        autoSubScopeHint: '选择订阅所有模型或仅订阅指定的分组和模型',
        subscribeAllModel: '订阅所有模型',
        selectiveSubscription: '选择性订阅',
        excludeGroup: '排除分组',
        excludeGroupHint: '选中的分组将不会被自动订阅，其他分组会被订阅',
        excludeGroupPlaceholder: '选择要排除的分组（不选则订阅所有分组）',
        excludeModel: '排除模型',
        excludeModelHint: '选中的模型将不会被自动订阅，其他模型会被订阅',
        excludeModelPlaceholder: '选择要排除的模型（不选则订阅所有模型）',
        selectGroup: '选择分组',
        selectGroupHint: '订阅选中分组下的所有模型（与选择模型为并集关系）',
        selectGroupPlaceholder: '选择要订阅的分组',
        selectModel: '选择模型',
        selectModelHint: '订阅选中的模型（与选择分组为并集关系）',
        selectModelPlaceholder: '选择要订阅的模型',
        isEnable: '是否启用',
...
if __name__ == "__main__":
    ...
    ci: {
        ...
        syncJumpServer: '同步到Jumpserve',
        syncJumpServerConfirm: '确认将选中的资产同步到Jumpserve吗？',
        syncJumpServerInProgress: '正在同步到Jumpserve...',
        syncJumpServerInProgress2: '正在同步到Jumpserve，共{total}个，成功{successNum}个，失败{errorNum}个',
        syncJumpServerSuccess: '同步到Jumpserve完成',
        batchDeleting: '正在删除...',
        ...
        qrcode: '二维码',
        qrcodeTitle: '设备二维码',
        qrcodeTip: '手机扫描二维码即可查看设备信息',
        qrcodeDownload: '下载二维码',
        qrcodeBatch: '批量二维码',
        qrcodeBatchTitle: '批量导出二维码',
        qrcodeBatchTip: '将选中设备的二维码批量导出，方便打印粘贴到物理设备上',
        qrcodeBatchEmpty: '请先选择设备',
        qrcodeExport: '导出二维码',
        qrcodeExportAll: '导出全部二维码',
        mobileDetail: '设备详情',
        coreInfo: '核心信息',
        parentRelations: '上游关系',
        childRelations: '下游关系',
        recentHistory: '最近变更',
        scanToView: '扫码查看',
        printQRCode: '打印二维码',
        ...
        recycle: '回收',
        recycleHeader: '服务器回收',
        recycleWarning: '回收操作会将选中的服务器从当前模型转移到回收站，原数据将被删除，请谨慎操作！',
        recycleConfirm: '确认要回收选中的 {count} 台服务器吗？',
        recycleSuccess: '成功回收 {count} 台服务器',
        recycleFailed: '回收操作失败',
        recyclePartialSuccess: '部分回收成功',
        recycleResult: '成功 {success} 台，失败 {failed} 台',
        jumpserverDeleteFailed: 'JumpServer资产删除失败',
        ipReleaseFailed: 'IP地址释放失败',
        cancelRecycle: '取消回收',
        cancelRecycleConfirm: '确认要取消回收选中的 {count} 台服务器吗？已删除的Jumpserve资产和IP地址将不会重新创建',
        cancelRecycleSuccess: '成功取消回收 {count} 台服务器',
        cancelRecycleFailed: '取消回收操作失败',
        cancelRecyclePartialSuccess: '部分取消回收成功',
        cancelRecycleResult: '成功 {success} 台，失败 {failed} 台',
        selectCount: '选中数量',
        serverUnits: '台服务器',
        delstatus: '回收状态',
        delstatusPlaceholder: '请选择回收状态',
        delstatusRequired: '请选择回收状态',
        delstatusPending: '待回收',
        delstatusRecycled: '已回收',
        delstatusConfirming: '待确认',
        recentRecycleList: '最近回收列表',
        recycleResourceOverview: '回收资源统计',
        recycleList: '回收列表',
        recycleDetail: '回收详情',
        searchPlaceholder: '搜索IP、主机名...',
        actions: '操作',
        hostname: '主机名',
        osVersion: '操作系统',
        updatedAt: '更新时间',
        ...
        gb: 'GB',
        modelConfig: '模型配置',
        vmserverTypeId: 'vmserver 模型 ID',
        delserverTypeId: 'delserver 模型 ID',
    },
    serviceTree: {
        remove: '移除',
        deleteNode: '移除 {name}',
    ...
    topo: {
        ...
        centralNodeTypeTip: '选择拓扑图的中心节点所属的CI模型类型',
        filterInstances: '中心节点实例',
        filterInstancesTip: '点击输入框右侧按钮，通过表达式筛选符合条件的CI实例作为中心节点',
    ...
    ipam: {
        ...
        scanSubnet: '扫描子网',
        scanSubnetSent: '扫描任务已发送到执行机器',
        scanSubnetFailed: '扫描子网失败',
        ...
        deleteAgentConfirm: '确定删除该 Agent 吗？',
