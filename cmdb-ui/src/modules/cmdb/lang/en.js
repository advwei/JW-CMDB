const cmdb_en = {
    ...
    menu: {
        ...
        ciTree: 'Hierarchy',
        syncasset: 'Asset Sync Info',
        configCenter: 'Config Center',
        recycleOverview: 'Recycle Overview',
        ciSearch: 'Search',
...
if __name__ == "__main__":
    ...
    ci: {
        ...
        syncJumpServer: 'Sync to Jumpserve',
        syncJumpServerConfirm: 'Sync selected assets to Jumpserve?',
        syncJumpServerInProgress: 'Syncing to Jumpserve...',
        syncJumpServerInProgress2: 'Syncing to Jumpserve, {total} in total, {successNum} successful, {errorNum} failed',
        syncJumpServerSuccess: 'Sync to Jumpserve completed',
        ...
        qrcode: 'QR Code',
        qrcodeTitle: 'Device QR Code',
        qrcodeTip: 'Scan QR code with phone to view device info',
        qrcodeDownload: 'Download QR Code',
        qrcodeBatch: 'Batch QR Code',
        qrcodeBatchTitle: 'Batch Export QR Codes',
        qrcodeBatchTip: 'Export QR codes for selected devices, convenient for printing and attaching to physical devices',
        qrcodeBatchEmpty: 'Please select devices first',
        qrcodeExport: 'Export QR Code',
        qrcodeExportAll: 'Export All QR Codes',
        mobileDetail: 'Device Detail',
        coreInfo: 'Core Info',
        parentRelations: 'Upstream Relations',
        ...
        recycle: 'Recycle',
        recycleHeader: 'Server Recycle',
        recycleWarning: 'Recycle will transfer selected servers to the recycle bin. Original data will be deleted. Please proceed with caution!',
        recycleConfirm: 'Are you sure you want to recycle {count} server(s)?',
        recycleSuccess: 'Successfully recycled {count} server(s)',
        recycleFailed: 'Recycle operation failed',
        recyclePartialSuccess: 'Partial recycle success',
        recycleResult: '{success} succeeded, {failed} failed',
        jumpserverDeleteFailed: 'JumpServer asset deletion failed',
        ipReleaseFailed: 'IP address release failed',
        cancelRecycle: 'Cancel Recycle',
        cancelRecycleConfirm: 'Are you sure you want to cancel recycle for {count} server(s)?',
        cancelRecycleSuccess: 'Successfully cancelled recycle for {count} server(s)',
        cancelRecycleFailed: 'Cancel recycle operation failed',
        cancelRecyclePartialSuccess: 'Partial cancel recycle success',
        cancelRecycleResult: '{success} succeeded, {failed} failed',
        selectCount: 'Selected Count',
        serverUnits: 'server(s)',
        delstatus: 'Recycle Status',
        delstatusPlaceholder: 'Please select recycle status',
        delstatusRequired: 'Please select recycle status',
        delstatusPending: 'Pending',
        delstatusRecycled: 'Recycled',
        delstatusConfirming: 'Confirming',
        recentRecycleList: 'Recent Recycle List',
        recycleResourceOverview: 'Recycle Resource Stats',
        recycleList: 'Recycle List',
        recycleDetail: 'Recycle Detail',
        searchPlaceholder: 'Search by IP, hostname...',
        actions: 'Actions',
        hostname: 'Hostname',
        ...
        vmserverTypeId: 'vmserver Type ID',
        delserverTypeId: 'delserver Type ID',
    },
    serviceTree: {
        remove: 'Remove',
    ...
    ipam: {
        ...
        scanSubnetSent: 'Scan task has been sent to the agent',
        scanSubnetFailed: 'Failed to scan subnet',
        ...
        deleteAgentConfirm: 'Are you sure to delete this agent?',
