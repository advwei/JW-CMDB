  ...
  const routes = {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: 'cmdb.menu.recycleOverview', icon: 'ops-cmdb-resource', selectedIcon: 'ops-cmdb-resource', keepAlive: false }
      },
      {
      ...
      {
        path: '/cmdb/syncasset',
        name: 'cmdb_sync_asset',
        component: () => import('../views/sync_asset/index.vue'),
        meta: { title: 'cmdb.menu.syncasset', icon: 'ops-cmdb-resource', selectedIcon: 'ops-cmdb-resource', keepAlive: false }
      },
      {
        path: '/cmdb/configcenter',
        name: 'cmdb_config_center',
        component: () => import('../views/sync_asset/configCenter.vue'),
        meta: { title: 'cmdb.menu.configCenter', icon: 'ops-cmdb-preference', selectedIcon: 'ops-cmdb-preference', keepAlive: false }
      },
      {
        path: '/cmdb/ansible_history',
        name: 'ansible_history',
        component: () => import('../views/ansible_history/index'),
        meta: { title: 'Ansible 执行日志', icon: 'ops-cmdb-operation', selectedIcon: 'ops-cmdb-operation', keepAlive: false }
      },
      {
